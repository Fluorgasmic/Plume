...
- **Tics** (toggle dans l'aperçu) : repère les **anglicismes, le jargon corporate et les clichés** (« impacter », « au final », « solution innovante »…) à partir d'une liste curée, avec une suggestion au survol. 100 % local.

> Lisibilité et Orthographe sont **activés par défaut** ; Tics est à activer au besoin. Tout se règle d'un clic dans l'en-tête de l'aperçu.
